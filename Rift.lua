...
-- Your job IDs (you already have them, truncate or paste yours)
local jobIds = {
        ...
        while wait(1) do
            pcall(function()
                for _, gui in pairs(game:GetService("CoreGui"):GetDescendants()) do
                    if gui:IsA("TextButton") and gui.Text:match("OK") then
...
function hopToNextServer()
    ...
    local scriptToQueue = CONTINUATION_SCRIPT
